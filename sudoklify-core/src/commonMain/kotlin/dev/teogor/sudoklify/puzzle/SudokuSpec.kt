...
public data class SudokuSpec(
  ...
  public data class Builder(
     ...
     */
    public fun difficulty(difficulty: Difficulty): Builder = apply {
     ...
     * @return This builder instance.
     */
    public inline fun difficulty(
      crossinline difficulty: () -> Difficulty,
    ): Builder = apply {
      this.difficulty = difficulty()
    }
     ...
     * @return This builder instance.
     */
    public fun seed(seed: Seed): Builder = apply { this.seed = seed }
     ...
     * @return This builder instance.
     */
    public inline fun seed(crossinline seed: () -> Seed): Builder = apply {
      this.seed = seed()
    }
     ...
     * @return This builder instance.
     */
    public fun type(type: Dimension): Builder = apply { this.type = type }
     ...
     * @return This builder instance.
     */
    public inline fun type(crossinline type: () -> Dimension): Builder = apply {
      this.type = type()
    }
 ...
 */
@SudoklifyDsl
public fun SudokuSpec(block: SudokuSpec.Builder.() -> Unit): SudokuSpec {
